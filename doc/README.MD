...
The above uses the **auth_oauth2_mod.json** file to generate the Python class library in the **Python** folder. The namespace and package name of the classes are **edp.auth**.
